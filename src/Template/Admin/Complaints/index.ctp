...
<div class="complaints index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('user_id', 'Complaint By') ?></th>
        ...
        <tbody>
            ...
            <tr>
                <td><?= $complaint->has('user') ? $this->Html->link($complaint->user->first_name." ". $complaint->user->last_name, ['controller' => 'Users', 'action' => 'view', $complaint->user->id]) : '' ?></td>
