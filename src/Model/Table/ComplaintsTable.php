 ...
 * @method \App\Model\Entity\Complaint|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Complaint saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class ComplaintsTable extends Table {
    ...
    public function validationDefault(Validator $validator) {
        ...
        $validator->scalar('tittle')->maxLength('tittle', 255)->requirePresence('tittle', 'create')->notEmptyString('tittle');

        $validator->scalar('complaint_body')->requirePresence('complaint_body', 'create')->notEmptyString('complaint_body');
