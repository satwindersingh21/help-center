...
class AdminsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'image_id' => 1,
                'created' => '2020-03-03 10:54:13',
                'modified' => '2020-03-03 10:54:13',
            ],
        ];
        parent::init();
    }
