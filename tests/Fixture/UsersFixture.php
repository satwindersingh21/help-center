...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'forgot_password_token' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'role' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'registration_steps_done' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'registration_steps_done' => 1,
                'active' => 1,
                'created' => '2020-03-03 10:58:39',
                'modified' => '2020-03-03 10:58:39',
            ],
        ];
        parent::init();
    }
